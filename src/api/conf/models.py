...
class Conf(models.Model):
    ...
    abstract_last_char = models.CharField(
            max_length=254,
            default="…",
    ...
    abstract_replaced_chars = models.CharField(
            max_length=254,
            default=",.!?…",
    ...
    piwik_analytics_url = models.CharField(
            max_length=2000,
            null=True,
            blank=True,
            verbose_name="Your piwik analytics url.",
            help_text="Enter here you piwik analytics url (without leading \
                    and trailing slashes \"/\")."
    )
    piwik_analytics_site_id = models.CharField(
            max_length=254,
            null=True,
            blank=True,
            verbose_name="Your piwik analytics site ID.",
            help_text="Enter here you piwik analytics site ID to start tracking."
    )
    ...
    registration_mail = models.BooleanField(
            default=True,
    ...
    date = models.DateTimeField(
            ...
            blank=True,
            db_index=True,
            verbose_name="Configuration date"
    )
