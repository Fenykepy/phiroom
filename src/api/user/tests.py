...
class UserAPITest(TestCase):
    ...
    def test_author_detail(self):
        ...
        self.assertEqual(response.data['website_link'], self.staffUser.website_link)
        self.assertEqual(response.data['blog_link'], self.staffUser.blog_link)
        self.assertEqual(response.data['etsy_link'], self.staffUser.etsy_link)
